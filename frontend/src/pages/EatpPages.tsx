...
const EATP_LINKS = (
  <div className="row-actions">
    ...
    <Link to="/fincas" className="btn">FTIP</Link>
    <Link to="/lotes" className="btn">FMDT</Link>
  </div>
);
...
export function EatpCenterPage() {
  ...
  return (
    <>
      <Header title="Centro Agrícola" subtitle="Plataforma AgriTech — Sprint 1" actions={EATP_LINKS} />
      ...
      <section className="card">
        <button className="btn btn-primary" onClick={() => bootstrapEatp().then(setCenter)}>Inicializar AgriTech</button>
      </section>
      <section className="card">
...
export function EatpFarmsPage() {
  ...
  return (
    <>
      <Header title="Administrador de Fincas" subtitle="FTIP bridge" actions={EATP_LINKS} />
      <section className="card">
...
export function EatpLotsPage() {
  ...
  return (
    <>
      <Header title="Administrador de Lotes" subtitle="FTIP + FMDT" actions={EATP_LINKS} />
      <section className="card">
...
export function EatpCropsPage() {
  ...
  return (
    <>
      <Header title="Centro de Cultivos" actions={EATP_LINKS} />
      <section className="card"><h3>Stands FTIP ({stands.length})</h3></section>
      <section className="card"><h3>Registro EATP ({registry.length})</h3></section>
    </>
  );
}
