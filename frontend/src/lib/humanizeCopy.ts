...
const TERM_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bENEAC\b/g, 'Notificaciones'],
  [/\bEIMS\b/g, 'Inventario'],
  [/\bCPEP\b/g, 'Compras de café'],
  [/\bSeed\b/g, 'Carga inicial'],
  [/\bSync\b/gi, 'Sincronización'],
  [/\bEntity\b/g, 'Registro'],
  [/\bModule\b/g, 'Área'],
  [/\bModules\b/g, 'Áreas'],
  [/\bESCM\b/g, 'Comercial'],
  ...
  [/\bidentity_validated\b/g, 'Identidad confirmada'],
  [/\bpending_review\b/g, 'En revisión'],
  [/\breceiving\b/gi, 'En recepción'],
  [/\bqueued\b/gi, 'En espera'],
  [/\barrived\b/gi, 'Recibido'],
  [/\bLifecycle\b/gi, 'Estado'],
  ...
  [/\bNo hay registros\.?/gi, 'Aún no hay información'],
