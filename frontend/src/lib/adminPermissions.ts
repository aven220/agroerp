...
export const ACTION_LABELS: Record<string, string> = {
  ...
  weigh: 'pesar con báscula',
  'weigh:manual': 'pesar manualmente (sin IoT)',
  ...
  'config:manage': 'crear/editar/desactivar configuración',
  'catalog:manage': 'crear/editar/desactivar catálogos',
  'audit:read': 'ver auditoría',
  item: 'crear/editar/desactivar artículos',
  warehouse: 'gestionar bodegas',
