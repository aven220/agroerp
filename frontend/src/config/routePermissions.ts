...
const ACTION_PERMISSIONS: Array<{ pattern: RegExp; permission: string }> = [
  ...
  { pattern: /^\/administracion/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/empresa$/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/modulos$/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/usuarios/, permission: 'user:update' },
  { pattern: /^\/implementacion\/roles/, permission: 'role:update' },
  { pattern: /^\/implementacion\/documentos/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/integraciones/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/configuracion/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/procesos/, permission: 'workflow:update' },
  { pattern: /^\/implementacion\/estado/, permission: 'organization:update' },
  { pattern: /^\/implementacion\/go-live/, permission: 'organization:update' },
  { pattern: /^\/implementacion$/, permission: 'organization:update' },
  { pattern: /^\/configuracion$/, permission: 'organization:update' },
  { pattern: /^\/compras\/config/, permission: 'coffee:config:manage' },

  { pattern: /^\/inventario\/parametros/, permission: 'inventory:config' },
